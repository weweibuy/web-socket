package com.weweibuy.socket.ws.controller;

import com.weweibuy.socket.ws.support.WebSocketUtil;
...
@Slf4j
@Controller
@ServerEndpoint("/socket/chat/{username}") //说明创建websocket的endpoint
